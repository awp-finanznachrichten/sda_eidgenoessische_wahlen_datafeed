...
text <- paste0(text,'<p class="paragraph">',texts_candidates_it[5],"</p>\n")
...
vorlage <- gsub("INSERT_NOTE",texts_candidates_it[6],vorlage)
...
#Datei speichern
setwd("./Output_Mars")
filename <- paste0(format(Sys.Date(),"%Y%m%d"),"_",counted_cantons$area_ID[c],"_NR_Candidates_Wahlen2023_it.xml")
