...
vorlage <- gsub("INSERT_NOTE",texts_candidates_fr[5],vorlage)
...
vorlage <- gsub("INSERT_DATELINE",counted_cantons_SR$hauptort_fr[c],vorlage)
...
#Datei speichern
setwd("./Output_Mars")
filename <- paste0(format(Sys.Date(),"%Y%m%d"),"_",counted_cantons_SR$area_ID[c],"_SR_Candidates_Wahlen2023_fr.xml")
