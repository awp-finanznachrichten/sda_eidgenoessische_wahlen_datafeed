...
for (c in 1:nrow(counted_cantons_SR)) {
  ...
  #   .[,4]
  # 
  headline <- paste0("Federali 2023: risultati del secondo turno dell'elezione per il Consiglio degli Stati nel canton ",counted_cantons_SR$area_name_it[c])
...
saveRDS(grafiken_uebersicht_it,"grafiken_uebersicht_it_candidates_SR_second_turn.RDS")
write.xlsx(grafiken_uebersicht_it,"grafiken_uebersicht_it_candidates_SR_second_turn.xlsx",row.names = FALSE)
