...
for (c in 1:nrow(counted_cantons_SR)) {
  ...
  headline <- paste0("Fédérales 2023: résultat du second tour de l'élection au Conseil des Etats dans le canton de ",counted_cantons_SR$area_name_fr[c])
...
saveRDS(grafiken_uebersicht_fr,"grafiken_uebersicht_fr_candidates_SR_second_turn.RDS")
write.xlsx(grafiken_uebersicht_fr,"grafiken_uebersicht_fr_candidates_SR_second_turn.xlsx",row.names = FALSE)
