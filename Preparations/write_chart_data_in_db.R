grafiken_uebersicht <- readRDS("./Preparations/grafiken_uebersicht.RDS")
grafiken_uebersicht_history <- readRDS("./Preparations/grafiken_uebersicht_history.RDS")
grafiken_uebersicht_elected <- readRDS("./Preparations/grafiken_uebersicht_elected.RDS")
grafiken_uebersicht_candidates_SR <- readRDS("./Preparations/grafiken_uebersicht_candidates_SR.RDS")
