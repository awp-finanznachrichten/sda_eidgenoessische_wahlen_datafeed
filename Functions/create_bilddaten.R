create_bilddaten <- function(chart_id,
  ...
  metadata <- paste0("i5_object_name=INFOGRAFIK ",object_name,"\n",
                     ...
                     "i15_category=N\n",
                     "i25_keywords=$KSTC-249aa500-4174-4a95-8976-59a4e639cfaf$\n",
  ...
  if (language == "it") {
    ...
    metadata <- paste0("i5_object_name=INFOGRAFICA ",object_name,"\n",
                       ...
                       ifelse(eps == "yes",
                              ...
                              "i40_special_instructions=L'infografica può essere ottenuta nei formati grafici SVG. Questa infografica è stata creata automaticamente dal robot di scrittura Lena.\n"),
                       "i110_credit=KEYSTONE\n",
                       "i115_source=KEYSTONE\n",
                       "i80_byline=Lena\n",
                       "i122_writer=Lena\n")
