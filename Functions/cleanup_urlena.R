cleanup_urlena <- function(nationalrat_gemeinden_dw) {
  ...
  nationalrat_gemeinden_dw$Text_de <- gsub("Die Grüne muss ","Die Grünen müssen ",nationalrat_gemeinden_dw$Text_de)
  ...
  nationalrat_gemeinden_dw$Text_de <- gsub("Kandidaten der Grüne","Kandidaten der Grünen",nationalrat_gemeinden_dw$Text_de)
  nationalrat_gemeinden_dw$Text_de <- gsub("Kandidat der Grüne ","Kandidat der Grünen ",nationalrat_gemeinden_dw$Text_de)
  nationalrat_gemeinden_dw$Text_de <- gsub("Kandidatin der Grüne ","Kandidatin der Grünen ",nationalrat_gemeinden_dw$Text_de)
  nationalrat_gemeinden_dw$Text_de <- gsub("Die Grüne erhält ","Die Grünen erhalten ",nationalrat_gemeinden_dw$Text_de)
  nationalrat_gemeinden_dw$Text_de <- gsub("Die Grüne steht ","Die Grünen stehen ",nationalrat_gemeinden_dw$Text_de)
  nationalrat_gemeinden_dw$Text_de <- gsub("zweitstärkste Partei, die Grüne,","zweitstärkste Partei, die Grünen,",nationalrat_gemeinden_dw$Text_de)
  nationalrat_gemeinden_dw$Text_de <- gsub("liegt die Grüne[.]","liegen die Grünen.",nationalrat_gemeinden_dw$Text_de)
  nationalrat_gemeinden_dw$Text_de <- gsub("unbestrittenes Territorium der Grüne","unbestrittenes Territorium der Grünen",nationalrat_gemeinden_dw$Text_de)
  nationalrat_gemeinden_dw$Text_de <- gsub("steht die Grüne ","stehen die Grünen ",nationalrat_gemeinden_dw$Text_de)
  nationalrat_gemeinden_dw$Text_de <- gsub("Die Grüne sammelt ","Die Grünen sammeln ",nationalrat_gemeinden_dw$Text_de)
  nationalrat_gemeinden_dw$Text_de <- gsub("Die Grüne behauptet ","Die Grünen behaupten ",nationalrat_gemeinden_dw$Text_de)
