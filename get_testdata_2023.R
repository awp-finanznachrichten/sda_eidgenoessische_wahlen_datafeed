...
###Results Parties
data_NR_parties <- fromJSON("C:/Users/sw/OneDrive/sda_eidgenoessische_wahlen_daten/Testdaten/Testdata_NR_2023_Completed/sd-t-17.02-NRW2023-parteien.json", flatten = TRUE)
...
data_NR_voterturnout<- fromJSON("C:/Users/sw/OneDrive/sda_eidgenoessische_wahlen_daten/Testdaten/Testdata_NR_2023_Completed/sd-t-17.02-NRW2023-wahlbeteiligung.json", flatten = TRUE)
...
###Results Candidates
data_NR_candidates <- fromJSON("C:/Users/sw/OneDrive/sda_eidgenoessische_wahlen_daten/Testdaten/Testdata_NR_2023_Completed/sd-t-17.02-NRW2023-kandidierende.json", flatten = TRUE)
...
data_SR_candidates <- fromJSON("C:/Users/sw/OneDrive/sda_eidgenoessische_wahlen_daten/Daten Wahlen 2019/sd-t-17.02-SRW2019-kandidierende-erster-wahlgang-2124808.json", flatten = TRUE)
